#!/usr/bin/env python3
"""
model/src/models/evaluate_all_models.py
=========================================
...
Runs on:
  python3 -m model.src.models.evaluate_all_models
"""
...
if missing_deps:
    ...
    print("    /opt/anaconda3/bin/python3 -m model.src.models.evaluate_all_models")
    print("    -or-")
